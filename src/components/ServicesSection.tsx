    ...
    <div className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-white/70 backdrop-blur-sm border border-gray-200 rounded-xl shadow-sm p-8 hover:bg-transparent hover:shadow-lg hover:border-gray-300 transition-all duration-300">
